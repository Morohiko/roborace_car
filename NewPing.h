...
//
// FEATURES:
// * Works with many different ultrasonic sensors: SR04, SRF05, SRF06, DYP-ME007, URM37 & Parallax PING)))в„ў.
...
//   don't use a library).
//
// 07/14/2012 v1.4 - Added support for the Parallax PING)))пїЅ sensor. Interface
